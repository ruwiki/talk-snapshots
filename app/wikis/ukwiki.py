...
WIKI = WikiSpec(
    ...
    locale=Locale(
        ...
        known_bots=frozenset({"WikiBot", "БотКонстантина", "AndriiBot", "TohaomgBot"}),
    ),
    ...
    outcome=OutcomeSection(
        ...
        kinds={
            r"швидко вилучен|вилучен[оаі]?|вилучити": "delete",
            r"залишен[оаі]?|залишити|залишаємо": "keep",
            r"перейменован[оаі]?|перейменувати": "rename",
            r"об'?єднан[оаі]?|об'?єднати": "merge",
            r"перенаправлен[оаі]?|перенаправити|редирект|перенесено до": "redirect",
            r"номінацію знято|знято|знімаю": "withdrawn",
        },
    ),
