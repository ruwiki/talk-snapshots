...
WIKI = WikiSpec(
    ...
    locale=Locale(
        ...
        tz="Europe/Berlin",
        known_bots=frozenset({"TaxonBot", "Xqbot", "GiftBot", "CactusBot", "APPERbot"}),
    ),
    ...
    outcome=HeadingSuffix(
        ...
        kinds={
            r"^gel|^SLA": "delete",
            r"^bleibt|^LAE|^behalten": "keep",
            r"^LAZ|zurückgezogen": "withdrawn",
            r"^Weiterleitung|^WL|^Redirect": "redirect",
            r"^verschoben": "moved",
            r"^erl": "other",
        },
    ),
